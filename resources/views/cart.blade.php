...
<div id="cartDrop" class="dropdown-content">
    <table class="table table-borderless" style="display: block" cellspacing="0" width="100%">
        ...
        <tbody style="display: block; min-height: 150px; max-height: 300px;overflow-y: auto;">
        @foreach($cart as $row)
            @php($i+=1)
